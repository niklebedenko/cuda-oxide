...
pub fn codegen_run(
    ...
    apply_common_codegen_env(&mut cmd, ctx, verbose);
...
pub fn codegen_cargo_passthrough(
    ...
    apply_common_codegen_env(&mut cmd, ctx, opts.verbose);
...
fn apply_common_codegen_env(cmd: &mut Command, ctx: &Context, verbose: bool) {
